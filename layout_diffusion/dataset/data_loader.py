...
from .fire import build_fire_dsets, fire_collate_fn_for_layout
...
def build_loaders(cfg, mode='train'):
    ...
    elif cfg.data.type == 'Fire':
        dataset = build_fire_dsets(cfg, mode=mode)
        collate_fn = fire_collate_fn_for_layout
    else:
